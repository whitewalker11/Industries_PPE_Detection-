...
def GUI_final():
    ...
    drop_box.place(x=130+300, y=160+50)
    upload_image2 = ImageTk.PhotoImage(Image.open(config["gui"]["upload2"]))
    ui2 = Label(root, bg=background, image=upload_image2)
    ui2.place(x=90+300, y=150+50)
    ...
    monthchoosen.place(x=110+300, y=200+50)
