...
def main(_argv):
    ...
    while True:
        ...
        if fr % 20 == 0:
            ...
            count += 1
            img  = draw_outputs(img, (boxes, scores, classes, nums), class_names, count, list_v, cam,pro,img1)
            ...
            if cv2.waitKey(1) == ord('q') or cv2.getWindowProperty('output', 0) == -1:
                break'''
